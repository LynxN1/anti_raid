...
class Client(Callbacks, SocketHandler):
    ...
    def login(self, email: str, password: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino_.lib.util.exceptions>`
        """
        data = json.dumps({
            "email": email,
            "v": 2,
    ...
    def check_device(self, deviceId: str):
        ...
        **Returns**
        ...
        data = json.dumps({
            "deviceID": deviceId,
            "bundleID": "com.narvii.amino_.master",
            "clientType": 100,
    ...
    def upload_media(self, file: BinaryIO, fileType: str):
        """
        Upload file to the amino_ servers.
    ...
    def sub_clients(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Community List <amino_.lib.util.objects.CommunityList>`
    ...
    def get_user_info(self, userId: str):
        ...
        **Returns**
            - **Success** : :meth:`User Object <amino_.lib.util.objects.UserProfile>`
    ...
    def get_chat_threads(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Chat List <amino_.lib.util.objects.ThreadList>`
    ...
    def get_chat_thread(self, chatId: str):
        ...
        **Returns**
            - **Success** : :meth:`Chat Object <amino_.lib.util.objects.Thread>`
    ...
    def get_chat_messages(self, chatId: str, size: int = 25, pageToken: str = None):
        ...
        **Returns**
            - **Success** : :meth:`Message List <amino_.lib.util.objects.MessageList>`
    ...
    def get_message_info(self, chatId: str, messageId: str):
        ...
        **Returns**
            - **Success** : :meth:`Message Object <amino_.lib.util.objects.Message>`
    ...
    def get_community_info(self, comId: str):
        ...
        **Returns**
            - **Success** : :meth:`Community Object <amino_.lib.util.objects.Community>`
    ...
    def search_community(self, aminoId: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <amino_.lib.util.exceptions>`
        """
        response = requests.get(f"{self.api}/g/s/search/amino_-id-and-link?q={aminoId}", headers=self.parse_headers(), proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else:
    ...
    def get_user_following(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`User List <amino_.lib.util.objects.UserProfileList>`
    ...
    def get_user_visitors(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Visitors List <amino_.lib.util.objects.VisitorsList>`
    ...
    def get_blocked_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Users List <amino_.lib.util.objects.UserProfileList>`
    ...
    def get_wall_comments(self, userId: str, sorting: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Comments List <amino_.lib.util.objects.CommentList>`
    ...
    def set_amino_id(self, aminoId: str):
        ...
        **Returns**
        ...
        response = requests.post(f"{self.api}/g/s/account/change-amino_-id", headers=self.parse_headers(data=data), data=data, proxies=self.proxies, verify=self.certificatePath)
        if response.status_code != 200: return exceptions.CheckException(json.loads(response.text))
        else: return response.status_code
    ...
    def get_membership_info(self):
        ...
        **Returns**
            - **Success** : :meth:`Membership Object <amino_.lib.util.objects.Membership>`
    ...
    def get_ta_announcements(self, language: str = "en", start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Blogs List <amino_.lib.util.objects.BlogList>`
    ...
    def get_wallet_info(self):
        ...
        **Returns**
            - **Success** : :meth:`Wallet Object <amino_.lib.util.objects.WalletInfo>`
    ...
    def get_from_deviceid(self, deviceId: str):
        ...
        **Returns**
            - **Success** : :meth:`User ID <amino_.lib.util.objects.UserProfile.userId>`
    ...
    def get_from_code(self, code: str):
        ...
        **Returns**
            - **Success** : :meth:`From Code Object <amino_.lib.util.objects.FromCode>`
    ...
    def get_all_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`User Profile Count List Object <amino_.lib.util.objects.UserProfileCountList>`
